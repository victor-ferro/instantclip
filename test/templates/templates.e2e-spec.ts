...
describe('Templates', () => {
    ...
    beforeAll(async () => {
      const moduleRef: TestingModule = await Test.createTestingModule({
        ...
        providers: [TemplatesService, {provide: 'TemplateDAO', useClass: DataTemplatesDAO}, TemplatesFindOne],
    ...
    it('/templates/:id (DELETE)', () => {
        return request(app.getHttpServer())
        .delete('/templates/A24')
        .expect(200)
    });
    it('/templates/:id (GET check DELETE)', () => {
        return request(app.getHttpServer())
          .get('/templates/A22')
          .expect(200)
          .expect(
